...
function getConfig(request) {
  ...
  config
    ...
    .setHelpText('Optional: Leave empty to query all tables in the database');
...
function validateConfig(configParams) {
  ...
  // tableName is optional: if empty, the connector will query all tables in the database
